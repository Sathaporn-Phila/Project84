Shader "Custom/DamageWall" {
	Properties {
		_BaseMap ("Main Texture", 2D) = "white" {}
		_BaseColor ("Base Color", Color) = (0, 0.66, 0.73, 1)
        _DamageColor ("Damage Color", Color) = (0, 0.66, 0.73, 1)
	...
	SubShader {
		...
		Pass {
			...
			half4 LitPassFragment(Varyings IN) : SV_Target {
                ...
                float DamageArea = 1-white;
                half4 mainColor = white*_BaseColor;
                half4 DamageColor = DamageArea*_DamageColor;
                half4 color = (mainColor + DamageColor)*IN.color;
