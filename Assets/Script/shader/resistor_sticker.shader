Shader "Custom/resistor_sticker"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 setResistor(Varyings input){
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                // below with your own.
                BRDFData brdfData;
                half4 stripColor = setResistor(input);
                InitializeBRDFData(stripColor, surfaceData.metallic, surfaceData.specular, surfaceData.smoothness, surfaceData.alpha, brdfData);
